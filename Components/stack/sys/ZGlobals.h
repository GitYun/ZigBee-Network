 ...
 * MACROS
 */
// BUILD_ALL_DEVICE 和 ZSTACK_DEVICE_BUILD 在 IAR 的设置中定义
// 这里只定义了 BUILD_ALL_DEVICE
...
#define ZG_BUILD_COORDINATOR_TYPE  (ZSTACK_DEVICE_BUILD & DEVICE_BUILD_COORDINATOR) // 0x01
#define ZG_BUILD_RTR_TYPE          (ZSTACK_DEVICE_BUILD & (DEVICE_BUILD_COORDINATOR | DEVICE_BUILD_ROUTER)) // 0x03
#define ZG_BUILD_ENDDEVICE_TYPE    (ZSTACK_DEVICE_BUILD & DEVICE_BUILD_ENDDEVICE)   // 0x04
#define ZG_BUILD_RTRONLY_TYPE      (ZSTACK_DEVICE_BUILD == DEVICE_BUILD_ROUTER) // 若定义了 BUILD_ALL_DEVICE，则为 0x07 == 0x02
#define ZG_BUILD_JOINING_TYPE      (ZSTACK_DEVICE_BUILD & (DEVICE_BUILD_ROUTER | DEVICE_BUILD_ENDDEVICE))   // 0x06
...
// 若在 IAR 中定义了预编译宏 BUILD_ALL_DEVICES，则 ZG_BUILD_COORDINATOR_TYPE、
// ZG_BUILD_RTR_TYPE、ZG_BUILD_ENDDEVICE_TYPE 均有值
