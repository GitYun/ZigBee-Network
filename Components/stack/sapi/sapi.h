...
#define ZB_BINDING_ADDR                   INVALID_NODE_ADDR		// 0xfffe
#define ZB_BROADCAST_ADDR                 0xffff

// SAPI Status Codes
#define ZB_SUCCESS                        ZSuccess  // 0x00
#define ZB_FAILURE                        ZFailure  // 0x01
#define ZB_INVALID_PARAMETER              ZInvalidParameter // 0x02
#define ZB_ALREADY_IN_PROGRESS            ZSapiInProgress   // 0x20
#define ZB_TIMEOUT                        ZSapiTimeout      // 0x21
#define ZB_INIT                           ZSapiInit         // 0x22
...
typedef struct
{
  osal_event_hdr_t hdr; // °üº¬ event ºÍ state
  uint16 data;
} sapi_CbackEvent_t;
